...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modx->addPackage('barcodegenerator', MODX_CORE_PATH . 'components/barcodegenerator/model/');
            $manager = $modx->getManager();
            $objects = [];
            $schemaFile = MODX_CORE_PATH . 'components/barcodegenerator/model/schema/barcodegenerator.mysql.schema.xml';
...
//             if(!$SFTypeObject = $modx->getObject("SFTypeObject",['name'=>$t['name']])){
//                 if($SFTypeObject = $modx->newObject("SFTypeObject",['name'=>$t['name']])){
//                     $SFTypeObject->save();
//                 }
//             }
//         }
